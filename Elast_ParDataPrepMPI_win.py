...
def extract_Elepart(MPGData):
    ...
    MeshPartFile = MatDataPath + 'MeshPart_' + str(N_TotalMshPrt) + '.bin'
    ElePart = loadBinDataInSharedMem(MeshPartFile, np.int32, int, (GlobNElem,), Comm)
    
    #if Rank==0:
    #    print(ElePart, ElePart.dtype, type(ElePart))
...
def extract_ElemMeshData(MPGData):
    ...
    GlobNElem       = MPGData['GlobData']['GlobNElem']
