...
def readLoadConfig(MatPath, GlobData):
    ...
    GlobSettingsFile = MatPath + 'TimeData.mat'
    ...
    Fixed =         FixedData['Fixed'] - 1                  #DOFs which are fixed
...
def configMP_GlobVectors(MeshPartList, F, M, DP0, DP1, Fixed, X0):
    ...
    for i in range(N_MeshPart):
        ...
        MP_FixedLocalDofVector = getIndices(MP_DofVector, np.intersect1d(MP_DofVector, Fixed))
