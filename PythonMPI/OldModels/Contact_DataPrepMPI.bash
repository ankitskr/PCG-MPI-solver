...
for P0 in 0 1 2 3 4 5 6 7 8; do 
    ...
    export JobName=Msh_${ModelName}_N$P0
	  ...
	  qsub -N $JobName -P $ProjName -q $Queue -l ncpus=$NCPU,walltime=$WallTime,mem=$TotMem,storage=gdata/$ProjName -M $Email -m ae -o $LogPath -j oe -v N_MshPrt,WorkDir,ScratchPath Contact_DataPrepMPI.pbs; 
